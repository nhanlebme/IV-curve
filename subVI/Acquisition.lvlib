...
<Library LVVersion="17008000">
	...
	<Item Name="close channel.vi" Type="VI" URL="../close channel.vi"/>
	<Item Name="Config chanel.ctl" Type="VI" URL="../Config chanel.ctl"/>
	<Item Name="config channel.vi" Type="VI" URL="../config channel.vi"/>
	<Item Name="initialize channel.vi" Type="VI" URL="../initialize channel.vi"/>
	<Item Name="Read data HW.vi" Type="VI" URL="../Read data HW.vi"/>
</Library>
